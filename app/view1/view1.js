...
.factory('messages', ['$http', function($http) {
	...
	return {
		...
		createNewSentence: function(id, dttm, txt) {
			return new Sentence(id, dttm, txt);
		},
